...
function install() {
  ...
  wsk -i package create $PACKAGE_NAME\
...
function uninstall() {
  ...
  wsk -i action delete $PACKAGE_NAME/ratingCreate
  wsk -i action delete $PACKAGE_NAME/questionCreate
  wsk -i action delete $PACKAGE_NAME/questionRead
  wsk -i action delete $PACKAGE_NAME/questionStats

  echo "Removing package..."
  wsk -i package delete $PACKAGE_NAME
...
function update() {
  ...
  wsk -i action update $PACKAGE_NAME/questionCreate    actions/question.create.js
  wsk -i action update $PACKAGE_NAME/questionRead      actions/question.read.js
  wsk -i action update $PACKAGE_NAME/questionStats     actions/question.stats.js
  wsk -i action update $PACKAGE_NAME/ratingCreate      actions/rating.create.js
}
...
function installApi() {
  wsk -i api create /emoting/1 /questions       PUT     emoting/questionCreate --response-type json
  wsk -i api create /emoting/1 /questions       GET     emoting/questionRead --response-type json

  wsk -i api create /emoting/1 /stats           GET     emoting/questionStats --response-type json

  wsk -i api create /emoting/1 /ratings         PUT     emoting/ratingCreate --response-type json
}

function uninstallApi() {
  wsk -i api delete /emoting/1
}
